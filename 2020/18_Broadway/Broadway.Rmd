...
glit<-c("glitter/softpink.png", "glitter/purple.png", "glitter/pink.png", "glitter/blue.png", "glitter/blue.png")
...
p3<-mamma%>%
  ggplot(aes(x=factor(year_), y= pct_capacity, color=seats_sold))+
  geom_jitter()+theme_ari(legpos = "none")+
  scale_y_continuous(labels = scales::percent)+
  scale_color_gradient(low=lowcol, high = highcol)+
  labs(subtitle="Percent of theatre capacity sold by total seats (color)",
...
p3<-mamma%>%
  ...
  geom_image(aes(x=factor(year_), y= pct_capacity, image=glitter), 
             size=0.05, position="jitter")+ #adds image
...
plot_grid(top, p2,p3, nrow=3, rel_heights = c(0.2,1, 0.5))
